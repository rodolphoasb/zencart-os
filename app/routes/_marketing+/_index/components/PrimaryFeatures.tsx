...
import screenshotCategories from '/images/screenshots/categories.png'
import screenshotOrder from '/images/screenshots/order.png'
import screenshotProduct from '/images/screenshots/product.png'
import screenshotProducts from '/images/screenshots/products.png'
...
export function PrimaryFeatures() {
  ...
  return (
    <section
      ...
      className="relative overflow-hidden bg-[#1F2937] pb-28 pt-20 sm:py-32"
    >
      {/* <img
      ...
      <Container className="relative">
        <div className="max-w-2xl md:mx-auto md:text-center xl:max-w-none">
          ...
          <p className="mt-6 text-lg tracking-tight text-white">
            Você recebe o pedido todo organizado, economizando tempo no
            atendimento.
          </p>
        </div>
        <Tab.Group
